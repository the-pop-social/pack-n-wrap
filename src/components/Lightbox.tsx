  ...
  return (
    ...
    >
      <div className="relative flex flex-col md:flex-row h-full min-h-[450px] md:h-[65vh] overflow-y-auto md:overflow-hidden no-scrollbar">
        ...
        <div className="w-full md:w-[45%] h-full p-6 md:p-8 flex flex-col justify-between overflow-y-auto bg-secondary/15 no-scrollbar">
          <div>
            {/* Occasion / Tags */}
            ...
            <div className="border-t border-primary/10 pt-5">
              ...
              <ul className="space-y-2.5">
                {hamper.details.map((detail, idx) => (
                  <li
                    key={idx}
                    className="flex items-start gap-2.5 text-xs text-charcoal/80 font-sans font-light"
                  >
          ...
          <div className="mt-8 border-t border-primary/10 pt-5 flex flex-col gap-3">
            ...
            <a
              ...
              className="flex p-5 items-center justify-center gap-2 bg-primary hover:bg-primary-dark text-white font-sans text-xs tracking-wider uppercase font-semibold py-4.5 rounded-full transition-all duration-300 shadow-md hover:shadow-lg active:scale-95"
            >
